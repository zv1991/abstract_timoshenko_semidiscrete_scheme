...
lam_u = 10  # Number of spatial oscillations in initial displacement u(x, 0)
lam_v = 10  # Number of spatial oscillations in initial rotation v(x, 0)
...
n = 4096                      # Number of time steps (uniformly spaced) over [0, T]
...
N = 44  # Number of Legendre polynomial basis functions (modal resolution in space)
